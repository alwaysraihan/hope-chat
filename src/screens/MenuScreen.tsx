...
const MenuScreen: React.FC<Props> = ({ navigation }) => {
  ...
  const menuItems = [
    ...
    {
      id: 'message-requests',
      title: t.message_requests_label,
    ...
    {
      id: 'friend-requests',
      title: activePage ? 'Followers' : t.friend_requests,
      ...
      {showSwitcher && (
        <View style={styles.switcherPanel}>
          ...
          <TouchableOpacity
            style={[
              styles.switcherRow,
              !activePage && styles.switcherRowActive,
            ]}
          ...
          >
            <FastImage
              source={
                profile?.avatarUrl ? { uri: profile.avatarUrl } : IC_PROFILE
              }
          ...
          {pages.map(page => (
            <TouchableOpacity
              ...
              style={[
                styles.switcherRow,
                activePage?.id === page.id && styles.switcherRowActive,
              ]}
